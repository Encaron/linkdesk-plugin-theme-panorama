...
- 配方 id `panorama` → `theme-panorama.panorama`
- 配色 id `moonlight` → `theme-panorama.moonlight`
...
- 意象：月夜装进一扇 40×28 的宽幅窗（该主题就是整窗一张主视觉），暖金月为唯一亮点
...
- 极限壳主题·background 域——全窗底图 + 半透明 chrome（月夜主视觉）
